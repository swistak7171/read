object Versions {
    ...
    const val APP_COMPAT: String = "1.3.0-beta01"
    const val CONSTRAINT_LAYOUT: String = "2.0.4"
    const val CORE: String = "1.5.0-beta01"
    const val ACTIVITY: String = "1.2.0"
    const val FRAGMENT: String = "1.3.0"
    const val PREFERENCE: String = "1.1.1"
    const val DATA_STORE: String = "1.0.0-alpha06"
    const val NAVIGATION: String = "2.3.3"
    const val NAVIGATION_SAFE_ARGS_GRADLE_PLUGIN: String = "1.0.0"
    const val LIFECYCLE: String = "2.3.0"
    const val CAMERA_X: String = "1.0.0-rc02"
    const val CAMERA_X_VIEW: String = "1.0.0-alpha21"
    ...
    const val RECYCLER_VIEW: String = "1.2.0-beta01"
    const val DAGGER: String = "2.32"
    const val ASSISTED_INJECT: String = "0.6.0"
    const val LEAK_CANARY: String = "2.6"
    const val MOSHI: String = "1.11.0"
    const val MATERIAL_DIALOGS: String = "3.3.0"
    const val FAST_ADAPTER: String = "5.3.4"
