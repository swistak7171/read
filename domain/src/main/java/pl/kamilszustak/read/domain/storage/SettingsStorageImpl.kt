...
class SettingsStorageImpl @Inject constructor(application: Application) :
    Storage(application, R.string.settings_data_store_name),
    SettingsStorage {

    override val isDailyReadingGoalEnabled: DataStoreValue<Boolean> = getValue(R.string.daily_reading_goal_data_store_value_name)
}