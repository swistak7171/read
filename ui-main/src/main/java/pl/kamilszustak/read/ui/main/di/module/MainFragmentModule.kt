...
import pl.kamilszustak.read.ui.main.collection.archive.ArchiveFragment
...
interface MainFragmentModule {
    ...
    @Binds
    @IntoMap
    @FragmentKey(ArchiveFragment::class)
    fun bindArchiveFragment(fragment: ArchiveFragment): Fragment
}